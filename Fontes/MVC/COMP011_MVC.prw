...
//FWMemoVirtual( oStruZA0, {{'ZA0_CDSYP1','ZA0_MMSYP1'},{'ZA0_CDSYP2','ZA0_MMSYP2'}}  )
...
//oView:SetFieldAction( 'ZA0_NOME'  , { |oView, cIDView, cField, xValue| Help(,,'HELP',,'Ação de Campo ' +  cField ,1,0) } )
//oView:SetFieldAction( 'ZA0_DTAFAL', { |oView, cIDView, cField, xValue| Help(,,'HELP',,'Ação de Campo ' +  cField ,1,0) } )
