...
// só é necessário quando o o fonte estiver com tipo errado no menu 
//(User Function => Tipo 3 | Function => Tipo 1|)
// ou quando o nome da Function não é EXATAMENTE IGUAL ao nome do arquivo fonte 
//oBrowse:SetMenuDef( 'COMP012_MVC' ) 
oBrowse:Activate()
...
While ! SX3->( EOF() ) .AND. SX3->X3_ARQUIVO == cAlias
	...
	bValid := FwBuildFeature( STRUCT_FEATURE_VALID , SX3->X3_VALID   )
	bWhen  := FwBuildFeature( STRUCT_FEATURE_WHEN  , SX3->X3_WHEN    )
	bRelac := FwBuildFeature( STRUCT_FEATURE_INIPAD, SX3->X3_RELACAO )
